...
import type { Publisher, Session, Subscriber, Stream, Device } from "openvidu-browser";
import axios from "axios";
import { UserVideoComponent } from "@/components";

import "./App.css";

export default function App() {
	const [mySessionId, setMySessionId] = useState<string | undefined>("SessionAAA");
	...
	const createToken = async (sessionId: string) => {
		const response = await axios.post(
			import.meta.env.VITE_API_URL + "api/sessions/" + sessionId + "/connections",
			{},
			{
				headers: { "Content-Type": "application/json" },
			},
